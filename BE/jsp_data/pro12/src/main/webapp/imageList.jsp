...
.lst_type li a:hover{text-decoration:underline; color:red;}
.lst_type li span{color:red; margin-left:330px; font-family:'돋움',Dotum;
font-size:14px;}
</style>
<meta charset="UTF-8">
...
<ul class='lst_type'>
	...
	<li>
		<a href='#' style='margin-left:50px' >
			<img src='image/duke5.png' width='90' height='90' alt='' /></a>
